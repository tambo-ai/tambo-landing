...
date: "2026-02-10"
description: "Tambo 1.0 is for building generative UI into React apps"
...
<ImageZoom>
    <img
      ...
      className="max-w-sm max-h-[400px] mx-auto rounded-md border border-border"
    />
</ImageZoom>
...
Building with Tambo? Join our [Discord](https://discord.com/invite/dJNvPEHth6) and tell us what you're working on.
